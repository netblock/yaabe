...
PPATUI_FUNCIFY(struct, mc_block_polaris_timings, atomtree_vram_info_header_v2_2,
	...
	(bios->mc_seq_wr_ctl_d0, "mc_seq_wr_ctl_d0",
	...
	(bios->mc_seq_misc1.gddr5_mr0, "gddr5_mr0",
		(ATUI_NODISPLAY, ATUI_INLINE, gddr5_mr0),
		((LANG_ENG, "seq_misc1"))
	),
	(bios->mc_seq_misc1.gddr5_mr1, "gddr5_mr1",
		(ATUI_NODISPLAY, ATUI_INLINE, gddr5_mr1),
		(ATUI_NODESCR)
	),
	(bios->mc_seq_misc3.gddr5_mr4, "gddr5_mr4",
		(ATUI_NODISPLAY, ATUI_INLINE, gddr5_mr4),
		((LANG_ENG, "seq_misc3"))
	),
	(bios->mc_seq_misc3.gddr5_mr5, "gddr5_mr5",
		(ATUI_NODISPLAY, ATUI_INLINE, gddr5_mr5),
		(ATUI_NODESCR)
	),
	(bios->mc_seq_misc8.gddr5_mr8, "gddr5_mr8",
		(ATUI_NODISPLAY, ATUI_INLINE, gddr5_mr8),
		((LANG_ENG, "seq_misc8"))
	),
	(bios->mc_seq_misc8.reserved, "reserved",
