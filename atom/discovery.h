...
// see also amdgpu/include/amd_shared.h
enum soc15_hwid:uint16_t {
	MP1_HWID          = 1, // System Management Controller; PSP+SMC=SMU
	MP2_HWID          = 2, // PCIe controller? ARM-based sensor controller?
	THM_HWID          = 3, // Thermal sensing and control
	SMUIO_HWID        = 4, // System Management Unit IO; rom access and other IO
	FUSE_HWID         = 5,
	CLKA_HWID         = 6, // clock manager for DCN/display
	PWR_HWID         = 10, // DCN/display thing
	GC_HWID          = 11, // Graphics and Compute
	UVD_HWID         = 12, // Unified Video Decoder
	VCN_HWID         = UVD_HWID, // Video Core/Codec Next
	AUDIO_AZ_HWID    = 13, // Intel Azalia audio (Intel HD Audio)
	ACP_HWID         = 14, // Audio Co-Processor
	DCI_HWID         = 15, // DCN sub IP ; DCN Info?
	DCO_HWID         = 16,
	XDMA_HWID        = 17, // peer-to-peer IO
	DCEAZ_HWID       = 18, // Display Controller Engine's Azalia?
	SDPMUX_HWID      = 19, // scalable data port?
	NTB_HWID         = 20, // PCI non-transparent bridge?
	VPE_HWID         = 21, // Video Processing Engine
	IOHC_HWID        = 24, // IOHUB Core
	L2IMU_HWID       = 28, // Integrated Management Unit (Power Management)
	VCE_HWID         = 32, // Video Compression Engine
	MMHUB_HWID       = 34, // MultiMedia Hub; memory hub
	ATHUB_HWID       = 35, // Address Translation Hub
	DBGU_NBIO_HWID   = 36,
	DFX_HWID         = 37,
	DBGU0_HWID       = 38,
	DBGU1_HWID       = 39,
	OSSSYS_HWID      = 40, // Interrupt Handler system?
	HDP_HWID         = 41, // Host Data Port IP for interfacing from the CPU to VRAM (PCI BAR)
	SDMA0_HWID       = 42, // System DMA Engine
	SDMA1_HWID       = 43, // System DMA Engine
	ISP_HWID         = 44, // Image Signal Processor
	DBGU_IO_HWID     = 45,
	DF_HWID          = 46, // Data Fabric
	CLKB_HWID        = 47,
	FCH_HWID         = 48,
	DFX_DAP_HWID     = 49,
	L1IMU_PCIE_HWID  = 50, // Integrated Management Unit (Power Management)
	L1IMU_NBIF_HWID  = 51, // Integrated Management Unit (Power Management)
	L1IMU_IOAGR_HWID = 52, // Integrated Management Unit (Power Management)
	L1IMU3_HWID      = 53, // Integrated Management Unit (Power Management)
	L1IMU4_HWID      = 54, // Integrated Management Unit (Power Management)
	L1IMU5_HWID      = 55, // Integrated Management Unit (Power Management)
	L1IMU6_HWID      = 56, // Integrated Management Unit (Power Management)
	L1IMU7_HWID      = 57, // Integrated Management Unit (Power Management)
	L1IMU8_HWID      = 58, // Integrated Management Unit (Power Management)
	L1IMU9_HWID      = 59, // Integrated Management Unit (Power Management)
	L1IMU10_HWID     = 60, // Integrated Management Unit (Power Management)
	L1IMU11_HWID     = 61, // Integrated Management Unit (Power Management)
	L1IMU12_HWID     = 62, // Integrated Management Unit (Power Management)
	L1IMU13_HWID     = 63, // Integrated Management Unit (Power Management)
	L1IMU14_HWID     = 64, // Integrated Management Unit (Power Management)
	L1IMU15_HWID     = 65, // Integrated Management Unit (Power Management)
	WAFLC_HWID       = 66, // related to XGMI
	FCH_USB_PD_HWID  = 67,
	SDMA2_HWID       = 68, // System DMA Engine
	SDMA3_HWID       = 69, // System DMA Engine
	PCIE_HWID        = 70, // PCIe
	PCS_HWID         = 80,
	DDCL_HWID        = 89,
	SST_HWID         = 90, // Single Stream Transport; display core
	LSDMA_HWID       = 91, // Light SDMA, mainly for kernel driver use
	IOAGR_HWID      = 100,
	NBIF_HWID       = 108, // new PCIe Bus Interface; sub-IPs of the NBIO
	IOAPIC_HWID     = 124, // Intel IO Advanced Programmable Interrupt Controller
	SYSTEMHUB_HWID  = 128,
	NTBCCP_HWID     = 144,
	UMC_HWID        = 150, // Unified Memory Controller
	SATA_HWID       = 168,
	USB_HWID        = 170,
	CCXSEC_HWID     = 176,
	XGMI_HWID       = 200,
	XGBE_HWID       = 216,
	MP0_HWID        = 255, // Platform Security Processor; PSP+SMC=SMU
	DMU_HWID        = 271, // DCN Management Unit
	DIO_HWID        = 272, // Display IO/output
	DAZ_HWID        = 274,
	HWID_MAX        = 300,
};
...
struct discovery_gc_info_v1_0 {
	struct discovery_info_header header;
	uint32_t num_se;
